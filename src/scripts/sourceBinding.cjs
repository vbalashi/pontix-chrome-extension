...
function normalizeWebPageSource(input = {}) {
...
function captureRangeLocator(params = {}) {
...
function createSelectionSourceBinding(params = {}) {
    ...
    return {
        ok: true,
        binding: {
            bindingVersion: 'pontix-selection-v1',
...
function bindingAppliesToContext(binding = {}, context = {}) {
    return Boolean(
...
function freezeActionEnvelope(binding, action = {}) {
    const clientEventId = action.clientEventId || '11111111-1111-4111-8111-111111111111';
    return Object.freeze({
        envelopeVersion: 'pontix-action-envelope-v1',
        clientEventId,
...
function buildSourceContextV2(binding = {}) {
    return {
...
function normalizeDocumentText(value) {
    return normalizeWhitespace(value).slice(0, 100000);
}
